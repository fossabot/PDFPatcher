...
internal sealed class TextInfo : ITextRegion
{
    ...
    internal static int CompareRegionX(ITextRegion a, ITextRegion b) => a == b ? 0 : CompareRegionX(a, b, true);
    ...
    internal static int CompareRegionY(ITextRegion a, ITextRegion b) => a == b ? 0 : CompareRegionY(a, b, true);
