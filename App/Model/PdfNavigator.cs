...
internal sealed class PdfNavigator : XPathNavigator
{
    ...
    private sealed class HtmlNameTable : XmlNameTable
    {
        ...
        public override string Add(string array) => _nameTable.Add(array);

        public override string Add(char[] array, int offset, int length) => _nameTable.Add(array, offset, length);

        public override string Get(string array) => _nameTable.Get(array);

        public override string Get(char[] array, int offset, int length) => _nameTable.Get(array, offset, length);

        internal string GetOrAdd(string array) => Get(array) ?? Add(array);
    }
    ...
    public override XPathNavigator Clone() => new PdfNavigator(this);
