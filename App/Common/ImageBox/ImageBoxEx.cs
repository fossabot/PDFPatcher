...
internal class ImageBoxEx : ImageBox
{
    ...
    private DragHandleAnchor HitTest(Point cursorPosition) => DragHandles.HitTest(cursorPosition);
    ...
    private void ProcessSelectionResize(Point cursorPosition)
    {
        ...
        bool resizingLeftEdge =
            ResizeAnchor is DragHandleAnchor.TopLeft or DragHandleAnchor.MiddleLeft or DragHandleAnchor.BottomLeft;
        bool resizingRightEdge = ResizeAnchor is DragHandleAnchor.TopRight or DragHandleAnchor.MiddleRight
            or DragHandleAnchor.BottomRight;
