namespace PDFPatcher.Functions
{
    partial class ExtractImageControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Text = "File name mask description:\r\n\"0000\": If there are less than four digits, use 0 to make up four digits.\r\n\"0\": The file name is based on the actual page number, without 0 fill.\r\nThe text can be enclosed in English double quotation marks (such as \"\\\" is about 2046\"0\", the preceding " +
                 "\"2046\" will not be interpreted as a placeholder).";
            //
            // tabPage3
            //
