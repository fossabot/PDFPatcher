...
public partial class PagePropertyForm : DraggableForm
{
    ...
    {
        public bool Equals(MuFontAndSize x, MuFontAndSize y) => x.FontName == y.FontName && x.Size == y.Size;

        public int GetHashCode(MuFontAndSize obj) => obj.FontName.GetHashCode() ^ obj.Size.GetHashCode();
    }
}
