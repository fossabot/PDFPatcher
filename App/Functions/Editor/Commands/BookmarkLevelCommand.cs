...
internal sealed class BookmarkLevelCommand : IEditorCommand
{
    ...
    public BookmarkLevelCommand(bool levelUp) => _levelUp = levelUp;

    public void Process(Controller controller, params string[] parameters) => BookmarkLevel(controller, _levelUp);
