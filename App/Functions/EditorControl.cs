...
public sealed partial class EditorControl : FunctionControl, IDocumentEditor, IEditView
{
    ...
    public void Reopen() => _ViewerBox.Reopen();
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        _ViewerButton.DropDownOpening += (_, _) => { SetupMenu(_ViewerButton.DropDownItems); };
        _OcrMenu.DropDownItemClicked += (_, args) => { _ViewerBox.OcrLanguage = (int)(args.ClickedItem.Tag ?? 0); };
        ...
        _ZoomBox.TextChanged += (_, _) => { _ViewerBox.LiteralZoom = _ZoomBox.Text; };
