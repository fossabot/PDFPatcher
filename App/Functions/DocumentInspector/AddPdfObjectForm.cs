...
public partial class AddPdfObjectForm : Form
{
    ...
    private void AddPdfObjectForm_Load(object sender, EventArgs e) => _NameValueBox.Location =
        _NumericValueBox.Location = _BooleanValueBox.Location = _TextValueBox.Location;
