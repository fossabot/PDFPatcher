namespace PDFPatcher.Functions
{
	partial class InfoFileOptionControl
	{
		...
		private void InitializeComponent () {
			...
			this.label2.Text = "Note: The content exported by the advanced export option is only for the purpose of studying the PDF file structure, and these content will not be imported when importing information files.";
			//
			// label5
			//
			...
			this.label5.Text = "This option will generate a large information file that contains most of the page (such as font, image information, etc.).";
			//
