...
internal sealed class TextPositionFilter : AutoBookmarkFilter
{
    ...
    internal override bool Matches(AutoBookmarkContext context) => context.TextLine == null
        ? MatchPosition(context.TextInfo.Region)
        : context.TextLine.Texts.Any(item => MatchPosition(item.Region));
