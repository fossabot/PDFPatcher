...
internal class PdfContentStreamProcessor
{
    ...
    internal PdfContentStreamProcessor() => Reset();
    ...
    protected void AdjustTextMatrixX(float x) => TextMatrix = new Matrix(x, 0f).Multiply(TextMatrix);
    ...
    private void EndMarkedContent() => markedContentStack.Pop();
    ...
    protected sealed class ResourceDictionary : PdfDictionary
    {
        ...
        public void Pop() => resourcesStack.RemoveAt(resourcesStack.Count - 1);

        public void Push(PdfDictionary resources) => resourcesStack.Add(resources);
    }
    ...
    protected sealed class TextMoveNextLine : IContentOperator
    {
        ...
        // Methods
        public TextMoveNextLine(TextMoveStartNextLine moveStartNextLine) => this.moveStartNextLine = moveStartNextLine;
