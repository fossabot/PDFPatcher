...
public class ModiOcr
{
    ...
    internal static bool IsLanguageInstalled(int langID) => __InstalledLanguage.Contains(langID);
    ...
    private static object Get(object instance, string propertyName) => instance.GetType()
        .InvokeMember(propertyName, BindingFlags.GetProperty, null, instance, EmptyArray);

    private static T Get<T>(object instance, string propertyName) => (T)Get(instance, propertyName);
