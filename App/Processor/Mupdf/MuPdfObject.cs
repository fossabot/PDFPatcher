...
public unsafe class MuPdfObject
{
    ...
    internal MuPdfDictionary AsDictionary() => new(Context, NativeMethods.ResolveIndirect(Context, Pointer));

    internal MuPdfArray AsArray() => new(Context, NativeMethods.ResolveIndirect(Context, Pointer));
...
public sealed unsafe class MuPdfDictionary : MuPdfObject
{
    ...
    public MuPdfObject GetValue(int index) => new(Context, NativeMethods.GetValue(Context, Pointer, index));

    public MuPdfObject Locate(string path) => new(Context, NativeMethods.Locate(Context, Pointer, path));

    public void Delete(string key) => NativeMethods.Delete(Context, Pointer, key);
...
public sealed unsafe class MuPdfArray : MuPdfObject
{
    ...
    public void Add(MuPdfObject obj) => NativeMethods.Push(Context, Pointer, obj.Pointer);
