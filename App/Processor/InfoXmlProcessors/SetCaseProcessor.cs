...
internal sealed class SetCaseProcessor : IPdfInfoXmlProcessor
{
    public enum LetterCase
    {
        ...
        ChineseNumber,
        TraditionalChineseNumbers,
        TraditionalToSimplifiedCjk,
        SimplifiedToTraditionalCjk
    }
    ...
    private static char FullWidthNumberToHalfWidth(char ch) => ch is >= '０' and <= '９' ? (char)(ch - '０' + '0') : ch;

    private static char HalfWidthNumberToFullWidth(char ch) => ch is >= '0' and <= '9' ? (char)(ch + '０' - '0') : ch;
    ...
    private sealed class StringMapper
    {
        ...
        public StringMapper(Converter<char, char> converter) => Converter = converter;
    ...
    public IUndoAction Process(XmlElement item)
    {
        ...
        return source == value
            ? null
            : UndoAttributeAction.GetUndoAction(item, Constants.BookmarkAttributes.Title, value);
    }
