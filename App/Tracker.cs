...
internal static class Tracker
{
    ...
    internal static void IncrementProgress(int progress) => ReportProgress(progress, "INC");

    internal static void IncrementTotalProgress() => ReportProgress(1, "TINC");

    internal static void SetProgressGoal(int goalNumber) => ReportProgress(goalNumber, "GOAL");

    internal static void SetTotalProgressGoal(int goalNumber) => ReportProgress(goalNumber, "TGOAL");
    ...
    internal static void TraceMessage(string message) => TraceMessage(Category.Message, message);
